...
export declare class OAuthService extends AuthConfig implements OnDestroy {
     ...
     * @param headers Optional additional http-headers.
     */
    fetchTokenUsingExternalTokenAndLoadUserProfile(provider: string, external_token: string, headers?: HttpHeaders): Promise<object>;
    /**
     ...
     * @param headers Optional additional http-headers.
     */
    fetchTokenUsingUsingExternalToken(provider: string, external_token: string, headers?: HttpHeaders): Promise<object>;
    /**
